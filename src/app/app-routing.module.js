...
var appRoutes = [
    ...
    { path: 'productList', component: product_list_component_1.ProductListComponent, data: { name: '商品列表' }, canActivate: [auth_guard_component_1.AuthGuard] },
    { path: 'productEdit', component: product_edit_component_1.ProductEditComponent, data: { name: '商品编辑' }, canActivate: [auth_guard_component_1.AuthGuard] },
    {
        path: '',
